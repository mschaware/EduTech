...
//                   'rounded-md px-3 py-2 text-lg font-bold' // Increased size and made text bold
//                 )}
//               >
//                 {item.name}
//               </a>
...
// <div className="flex flex-1 items-center justify-start"> {/* Changed justify-center to justify-start */}
//   <div className="hidden sm:ml-6 sm:block">
//     <div className="flex space-x-4">
//       {navigation.map((item) => (
//         <a
...
//           aria-current={item.current ? 'page' : undefined}
//           className={classNames(
//             'text-white hover:bg-gray-700 hover:text-white', // Removed black background
//             'rounded-md px-3 py-2 text-lg font-bold' // Increased size and made bold
//           )}
//         >
//           {item.name}
//         </a>
